...
- 85% «да» в рабочий день — API настроено доброжелательно, почти как джун, который ещё всем верит.
...
- 10% «да» на выходных — самый низкий шанс, и фразы там в основном предлагают пойти прогуляться.
